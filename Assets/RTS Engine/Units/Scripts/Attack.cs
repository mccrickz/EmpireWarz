...
namespace RTSEngine
{
    public class Attack : MonoBehaviour
    {
        ...
        public bool AttackOnlyInList = true; //Be able to attack the units/buildings in the below list only? or be able to attack all units/buidlings beside the ones in the list below.
        ...
        void UpdateAttackAnimTimer()
        {
            ...
            else
            {
                ...
                if (UnitMgr.CurrentAnimState == UnitAnimState.Attacking)
                {
                    //UnitMgr.AnimMgr.SetBool("IsAttacking", false);
                    UnitMgr.SetAnimState(UnitAnimState.Idle);
                }
            }
        }
        ...
        void Update()
        {
            ...
            //Unit only:
            if (AttackerType == AttackerTypes.Unit && UnitMgr.AttackMgr == this)
            {
