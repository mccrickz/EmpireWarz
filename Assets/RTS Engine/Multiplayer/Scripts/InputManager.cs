    ...
    public class InputManager : MonoBehaviour
    {
        ...
        public void LaunchCommand(InputVars Command)
        {
            ...
            { //spawning the faction capital building
                ...
                if (FactionTypeID >= 0 && GameMgr.FactionDef[FactionTypeID].CapitalBuilding != null)
                { //if the faction belongs to a certain type

                    //set the new capital building:
                    Capital = Instantiate(GameMgr.FactionDef[FactionTypeID].CapitalBuilding.gameObject, Command.InitialPos, Quaternion.identity);
                }
